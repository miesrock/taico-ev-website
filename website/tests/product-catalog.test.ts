...
const expectedCatalogProducts = {
  ...
  "TKMC-1000": {
    ...
    catalogApplications: ["Mobile EV Charger"], solutionSlugs: ["charge-on-demand"], applicationSlugs: ["on-demand-charging"],
  },
  "TKMC-2000P": {
    ...
    catalogApplications: ["Mobile Charger", "AC Output"], solutionSlugs: ["ac-output-e-generator"], applicationSlugs: ["ac-output-e-generator"],
  },
  "TKMC-4000": {
  ...
  "TKMC-2000": {
    ...
    catalogApplications: ["PV-Storage Charging Station", "Grid Complementary System"], solutionSlugs: ["pv-ess-charging"], applicationSlugs: ["pv-ess-charging-station"],
  },
  "TKMC-2600": {
...
test("matches the frozen TAICO MC v1.3 catalog facts", () => {
  ...
  for (const product of products) {
    ...
    assert.deepEqual(breadcrumbSchema.itemListElement, [
      ...
      { "@type": "ListItem", position: 3, name: product.model, item: `https://taicoev.com/products/${product.slug}/` },
    ]);
  }
});
