...
export const icpRelations = [
  { id: "rel-tkmc-800-1500-roadside-assistance", icpSlug: "roadside-assistance-provider", relatedProductSlugs: ["tkmc-800", "tkmc-1500"], relatedApplicationSlugs: ["roadside-ev-rescue"], relatedSolutionSlugs: ["emergency-ev-charging"], strength: "primary", scenarioFit: 5, evidenceLevel: "E1", evidenceIds: ["ev-rel-tkmc-800-1500-roadside-assistance"] },
  { id: "rel-tkmc-800-1500-ev-mobility", icpSlug: "ev-mobility-service-provider", relatedProductSlugs: ["tkmc-800", "tkmc-1500"], relatedApplicationSlugs: ["roadside-ev-rescue"], relatedSolutionSlugs: ["emergency-ev-charging"], strength: "secondary", scenarioFit: 3, evidenceLevel: "E1", evidenceIds: ["ev-rel-tkmc-800-1500-ev-mobility"] },
  { id: "rel-tkmc-800-1500-automotive-club", icpSlug: "automotive-club", relatedProductSlugs: ["tkmc-800", "tkmc-1500"], relatedApplicationSlugs: ["roadside-ev-rescue"], relatedSolutionSlugs: ["emergency-ev-charging"], strength: "secondary", scenarioFit: 3, evidenceLevel: "E1", evidenceIds: ["ev-rel-tkmc-800-1500-automotive-club"] },
